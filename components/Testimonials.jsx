    ...
    <div className=' min-h-screen flex flex-col  items-center'>
        ...
        <div className=' flex flex-col md:flex-row '>
            ...
            <div className=' w-full md:mt-12 md:w-1/2'>
                ...
                <h1 className='text-[30px] md:text-[60px] font-[700]'>What Our Customers <br />Say About Us</h1>
                <span className='text-[18px] md:text-[26px] font-[500] mt-3'>
                ...
                <div className='mt-4 flex flex-col md:flex-row gap-4'>
                    <div className='flex'>
                        <Image src="/Mask group.png" alt='users' height={30} width={80}/>
                        <Image src="/Mask group-1.png" alt='users' height={30} width={80} className=' -ml-6'/>
                        <Image src="/Mask group-2.png" alt='users' height={30} width={80} className=' -ml-6' />
                    </div>
                    <div>
                        <h1 className=' text-[26px] font-[600]'>Customer Feedback</h1>
