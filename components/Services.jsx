  ...
  return (
    <div className=' min-h-screen mt-4 flex flex-col md:flex-row gap-3'>
        <div className=' flex flex-col w-full md:w-1/2 '>
            <span className='text-[14px]  mt-4 md:text-[20px] text-red font-[700] '>Our Story & Services</span>
            ...
            <button className=' bg-[#39DB4A] mt-6 text-center flex items-center justify-center text-[26px] text-white rounded-3xl w-[217px] h-[80px]'>Explore</button>
        </div>
