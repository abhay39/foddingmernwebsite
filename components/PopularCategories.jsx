...
const PopularCategories = () => {
  ...
  return (
    <div className=' min-h-screen flex items-center flex-col justify-center'>
        ...
        <div className=' flex w-full flex-col justify-between md:flex-row gap-3 mb-2'>
            {
                itemsLists.map((item,index)=>{
                    return(
                        <div key={index} className=' h-[326px] w-full md:w-[326px] bg-white flex flex-col items-center justify-center rounded-lg'>
